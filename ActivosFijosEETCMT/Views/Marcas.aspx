                            ...
                            <div class="box-header">
                                ...
                                <%--<button id="btnNuevaMarca" type="button" class="btn btn-primary">
                                 <span class='fa fa-apple'></span> Nueva Marca</button>--%>
                                     ...
                                     <asp:LinkButton ID="btnNuevaMarca" runat="server" Text="<span class='fa fa-apple'></span> Nueva Marca" CssClass="btn btn-primary" OnClick="btnNuevaMarca_Click">
                                   </asp:LinkButton>
                                ...
                                <div class="box-body table-responsive">
                                    <div>
                                        <dx:ASPxGridView ID="gridMarcas" runat="server" AutoGenerateColumns="False" EnableTheming="True"
                                            Theme="Metropolis" Width="100%" Caption="Marcas">
                                            <Columns>
                                                ...
                                                <dx:GridViewDataTextColumn Caption="Nombre" FieldName="nombre" VisibleIndex="2">
                                                    ...
                                                    <CellStyle VerticalAlign="Middle" Font-Bold="True" Font-Size="Large" HorizontalAlign="Center">
                                                    </CellStyle>
                                                </dx:GridViewDataTextColumn>
                                            </Columns>
                        ...
                        <div id="div_modelos" class="box box-warning" runat="server">
                            ...
                            <%--    <button id="btnNuevoModelo" type="button" class="btn btn-primary">--%>
                                    <%--    <span class="fa fa-file-text-o"></span> Modelo</button>--%>
                                     <asp:LinkButton ID="btnNuevoModelo" runat="server" Text="<span class='fa fa-file-text-o'></span> Nuevo Modelo" CssClass="btn btn-primary" OnClick="btnNuevoModelo_Click"
                                   ></asp:LinkButton>
                                ...
                                <div class="box-body table-responsive">
                                    <div>
                                        <dx:ASPxGridView ID="gridModelos" runat="server" AutoGenerateColumns="False" EnableTheming="True"
                                            Theme="Metropolis" Width="100%" Caption="Modelos">
                                            <Columns>
                                                <dx:GridViewDataTextColumn Caption="Id" FieldName="ID" VisibleIndex="1" Visible="False">
                                                    <PropertiesTextEdit>
                                                        <ValidationSettings ErrorText="Valor inválido">
                                                ...
                                                <dx:GridViewDataTextColumn Caption="Nombre" FieldName="nombre" VisibleIndex="2">
                                                    ...
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <CellStyle VerticalAlign="Middle" Font-Bold="True" Font-Overline="False" Font-Size="Large" HorizontalAlign="Center">
                                                    </CellStyle>
                                                </dx:GridViewDataTextColumn>
                                            </Columns>
                                            <SettingsBehavior AllowFocusedRow="True" />
                                                      ...
                                                      <div class="col-xs-12">
                                                       <label>Marca</label>
                                                          <asp:TextBox ID="txtMarcaPopUp" runat="server"  CssClass="form-control" ReadOnly=true></asp:TextBox>
                                                            ...
                                                            <asp:TextBox ID="txtIdModelo" runat="server" Visible="false" Enabled="false"></asp:TextBox>
                                                            <div class="col-xs-12">
                                                                <label for="nombre">
                                                                    Modelo</label>
