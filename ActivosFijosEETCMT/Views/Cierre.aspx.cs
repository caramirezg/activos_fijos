...
namespace ActivosFijosEETC.Views
{
    public partial class Cierre : System.Web.UI.Page
    {
        ...
        protected void btnVerCierre_Click(object sender, EventArgs e)
        {
            ...
            Response.Write("<script>window.open('reportes/ReporteCierreGestion.aspx?f_cierre=" + f_cierre + " &formato=excel' ,'_blank');</script>");
        ...
        protected void btnVerCierrePdf_Click(object sender, EventArgs e)
        {
            DateTime f_cierre = DateTime.Parse(ddlPeriodosCerrados.SelectedItem.Text);
            Response.Write("<script>window.open('reportes/ReporteCierreGestion.aspx?f_cierre=" + f_cierre + " &formato=pdf','_blank');</script>");
        }
