...
namespace ActivosFijosEETC.Views
{
    public partial class Marcas : System.Web.UI.Page
    {
        ...
        {
            ClientScript.RegisterStartupScript(GetType(), "mostrarPopupMarcasNuevo", "modalNuevaMarcas();", true);
        ...
        {
            ClientScript.RegisterStartupScript(GetType(), "mostrarPopupNuevoModelo", "modalNuevoModelo();", true);
            txtIdModelo.Text = "";
