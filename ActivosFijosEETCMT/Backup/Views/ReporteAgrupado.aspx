<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteAgrupado.aspx.cs" Inherits="ActivosFijosEETC.Views.ReporteAgrupado" %>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box-body">
                            <asp:LinkButton ID="btnGenerarReporte" runat="server" CssClass="btn btn-warning" 
                                Text="<span class='fa fa-print'></span>Generar Reporte" onclick="btnGenerarReporte_Click"></asp:LinkButton>
                                ...
                                Text="Generar Reporte" onclick="btnGenerarReporte_Click" />--%>
                                    ...
                                    <div class=box-body>
                                        <asp:DropDownList ID="ddlTipoReporte" runat="server" CssClass="form-control">
                                            ...
                                            <asp:ListItem Text="Reporte por gerencia" Value="gerencia" />
                                            <asp:ListItem Value="estacion">Reporte por estación</asp:ListItem>
                                            <asp:ListItem Value="linea">Reporte por línea</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                            </div>
