...
{
    public partial class ExistenciasActivosPorFechas : System.Web.UI.Page
    {
        ...
        protected void btnGenerarReporte_Click(object sender, EventArgs e)
        {
            ...
            Response.Write("<script>window.open('reportes/ReporteExistenciasActivosPorFecha.aspx?fecha_inicio=" + fecha_inicio + " &fecha_fin=" + fecha_fin + " ','_blank');</script>");
        }
    }
}