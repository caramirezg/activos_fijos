    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            <section class="content-header">
                <h1>
                    Personal <small>Registro Alterno de Personal</small>
                </h1>
                <ol class="breadcrumb">
                    ...
                    <div class="col-md-12">
                        <div  class="box box-primary" runat="server">
                            ...
                            <strong>Correcto!</strong>
                                ...
                                <button id="btnNuevoPersona" type="button" class="btn btn-primary">
                                    Adicionar Persona</button>
                                <asp:Button ID="btnEditaPersona" runat="server" CssClass="btn btn-primary" 
                                    Text="Editar" onclick="btnEditaPersona_Click" />
                              
                            </div>
                            <div class="box">
                                <div class="box-body table-responsive">
                                    <dx:ASPxGridView ID="gridPersonas" runat="server" AutoGenerateColumns="False" 
                                        Theme="Aqua" Width="100%" EnableTheming="True">
                                        <Columns>
