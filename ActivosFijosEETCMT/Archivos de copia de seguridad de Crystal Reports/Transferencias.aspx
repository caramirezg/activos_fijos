        ...
        <aside class="left-side sidebar-offcanvas">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview"><a href="#"><i class="fa fa-edit"></i><span>Parametrización</span>
                    ...
                    <li class="treeview"><a href="#"><i class="fa fa-gift"></i><span>Donación</span> <i
                    ...
                    <li class="treeview"><a href="#"><i class="fa fa-laptop"></i><span>Activos</span> <i
                        class="fa fa-angle-left pull-right"></i></a>
                        <ul class="treeview-menu">
                            <li><a href="pages/UI/general.html"><i class="fa fa-angle-double-right"></i>Códigos
                                de barra</a></li>
                            <li><a href="RegistroActivosPorCompras.aspx"><i class="fa fa-angle-double-right"></i>
                                Registro de activos</a></li>
                    ...
                    <li class="treeview"><a href="#"><i class="fa fa-bar-chart-o"></i><span>Reportes</span>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="pages/charts/inline.html"><i class="fa fa-angle-double-right"></i>Activos
                                sin seguro</a></li>
                                ...
                                <div id="jqxgrid">
                                    ...
                                    <div>
                                        <dx:ASPxGridView ID="gridTranferencia" runat="server" AutoGenerateColumns="False"
                                            Width="100%" Theme="Aqua" Caption="Transferencias Realizadas" Font-Size="Small"
                                            ...
                                            <Columns>
                                                ...
                                                <dx:GridViewDataTextColumn Caption="Descripción" VisibleIndex="1" FieldName="descripcion"
                                                    Width="450px">
                                                    <PropertiesTextEdit>
                                                        <ValidationSettings ErrorText="Valor inválido">
                                                            <RegularExpression ErrorText="Falló la validación de expresión Regular"></RegularExpression>
                                                ...
                                                <dx:GridViewDataTextColumn Caption="Fecha Transferencia" VisibleIndex="2" FieldName="f_transferencia"
                                                    Width="150px">
                                                    <PropertiesTextEdit>
                                                        <ValidationSettings ErrorText="Valor inválido">
                                                            <RegularExpression ErrorText="Falló la validación de expresión Regular"></RegularExpression>
                                                ...
                                                <dx:GridViewDataTextColumn FieldName="origen" Caption="Origen" VisibleIndex="3" Width="200px">
                                                    <PropertiesTextEdit>
                                                        <ValidationSettings ErrorText="Valor inv&#225;lido">
                                                ...
                                                <dx:GridViewDataTextColumn Caption="Monto Bs" VisibleIndex="4" FieldName="monto_bs"
                                                    Width="150px">
                                                    <PropertiesTextEdit>
                                                        <ValidationSettings ErrorText="Valor inv&#225;lido">
                                                            <RegularExpression ErrorText="Fall&#243; la validaci&#243;n de expresi&#243;n Regular">
                                                ...
                                                <dx:GridViewDataTextColumn Caption="Monto UFV" VisibleIndex="5" FieldName="monto_ufv"
                                                    Width="150px">
                                                    <PropertiesTextEdit>
                                                        <ValidationSettings ErrorText="Valor inválido">
                                                            <RegularExpression ErrorText="Falló la validación de expresión Regular"></RegularExpression>
                                                ...
                                                <dx:GridViewDataTextColumn Caption="Monto Sus" VisibleIndex="6" FieldName="monto_sus"
                                                    Width="150px">
                                                    <PropertiesTextEdit>
                                                        <ValidationSettings ErrorText="Valor inválido">
                                                            <RegularExpression ErrorText="Falló la validación de expresión Regular"></RegularExpression>
                                                ...
                                                <dx:GridViewDataTextColumn Caption="Tasa Sus" VisibleIndex="8" FieldName="tasa_sus"
                                                    Width="100px">
                                                    <PropertiesTextEdit>
                                                        <ValidationSettings ErrorText="Valor inválido">
                                                            <RegularExpression ErrorText="Falló la validación de expresión Regular"></RegularExpression>
                                                ...
                                                <dx:GridViewDataTextColumn Caption="Tasa UFV" VisibleIndex="7" FieldName="tasa_ufv"
                                                    Width="100px">
                                                    <PropertiesTextEdit>
                                                        <ValidationSettings ErrorText="Valor inválido">
                                                            <RegularExpression ErrorText="Falló la validación de expresión Regular"></RegularExpression>
                                                ...
                                                <dx:GridViewDataTextColumn Caption="Doc. Respaldo" FieldName="doc_respaldo" VisibleIndex="12"
                                                    Width="250px">
                                                    <PropertiesTextEdit>
                                                        <ValidationSettings ErrorText="Valor inválido">
                                                            <RegularExpression ErrorText="Falló la validación de expresión Regular" />
                                                ...
                                                <dx:GridViewDataTextColumn Caption="Estado Proceso" VisibleIndex="17" FieldName="estado_proceso"
                                                    Width="160px">
                                                    <PropertiesTextEdit>
                                                        <ValidationSettings ErrorText="Valor inválido">
                                                            <RegularExpression ErrorText="Falló la validación de expresión Regular"></RegularExpression>
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-xs-3">
                                        ...
                                        <input id="dateFechaTransferencia" type="text" name="dateFechaTransferencia" value=""
                                    ...
                                    <div class="col-xs-2">
                                        &nbsp;<label for="nombre">Origen</label><asp:TextBox ID="txtOrigen" CssClass="form-control"
                ...
                <div class="row" id="div_comiteTransferencia" runat="server">
                    <div class="col-md-12">
                        <div id="div2" class="box box-primary" runat="server">
                            <div class="box-header">
                                <h3 class="box-title">
                                    Comité de Recepción de Transferencia</h3>
                            </div>
                            <div class="box-body">
