    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            <section class="content-header">
                <h1>
                    Auxiliares Contables <small></small>
                </h1>
                <ol class="breadcrumb">
            ...
            <section class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div id="div_auxiliares" class="box box-primary" runat="server">
                            <div class="box-header">
                                <h3 class="box-title">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <label for="nombre">
                                                    Sigla</label>
                                                <asp:TextBox ID="sigla" CssClass="form-control" placeholder="ejemplo: ES" runat="server" MaxLength="2"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
